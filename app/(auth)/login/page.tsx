    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700 relative overflow-hidden">
      ...
      <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-10 w-full max-w-md relative z-10 border border-white/20">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-5 rounded-2xl mb-6 shadow-xl">
          ...
          <p className="text-slate-600 text-center font-medium text-base">
            Manage your ticket sales with ease
          </p>
        </div>
        ...
        <form action={signInWithDiscord} className="space-y-4">
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-[#5865F2] to-[#4752C4] hover:from-[#4752C4] hover:to-[#3c44a8] text-white font-bold py-4 px-6 rounded-xl transition duration-300 flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
          >
            <svg
              className="w-7 h-7"
              fill="currentColor"
            ...
            <span className="text-lg">Sign in with Discord</span>
          </button>
        </form>

        <div className="mt-8 text-center space-y-2">
          <div className="flex items-center justify-center space-x-6 text-sm font-semibold text-slate-700">
